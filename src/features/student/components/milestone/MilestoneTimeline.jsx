...
const MilestoneTimeline = ({ milestones, selectedMilestone, onSelectMilestone }) => {
  return (
    <div className="bg-white rounded-lg shadow-md w-full">
      <header className="sticky top-0 text-xl font-bold flex items-center gap-2 truncate rounded-t-lg bg-white border-b border-gray-200 p-4">
        Milestone Timeline
      </header>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className='flex gap-2'>
                    ...
                    <h3 className="font-semibold text-gray-900 truncate flex flex-col justify-center">
                      {milestone.title}
                    </h3>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-gray-600 mt-1 flex-wrap ml-3">
                    <Calendar size={12} />
