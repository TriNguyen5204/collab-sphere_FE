            ...
            <div className='animate-fade-in'>
              ...
              <div className='flex justify-between mt-4'>
                ...
                <button
                  ...
                  className={`px-6 py-2.5 rounded-lg font-semibold transition-all text-sm ${formData.studentIds.length === 0
                      ? 'bg-slate-300 cursor-not-allowed text-slate-500'
            ...
            <div className='animate-fade-in'>
              ...
              <div className='flex justify-between mt-8'>
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-10 py-3.5 rounded-xl transition-all font-bold flex items-center gap-2 ${isLoading
                      ? 'opacity-70 cursor-not-allowed'
                      : 'hover:shadow-lg shadow-emerald-200 transform hover:scale-105 active:scale-95'
                    }`}
                >
                  {isLoading ? (
                    <>
