            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  ...
                  <span className="hidden sm:inline max-w-[160px] truncate">{fullName || 'Staff'}</span>
    ...
    {!isAuthenticated && (
      <div className="px-4 pt-6">
        <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-4 text-center">
          <p className="text-sm font-medium text-slate-700">Sign in to access staff tools</p>
  ...
  const navigationItems = [
    {
      ...
      icon: UserGroupIcon,
      match: path => path === '/staff/lecturers' || path.startsWith('/staff/lecturers/')
    },
    {
      label: 'Manage Class',
      href: '/staff/classes',
      icon: AcademicCapIcon,
      match: path => path === '/staff/classes' || path.startsWith('/staff/classes/')
    },
  ];
