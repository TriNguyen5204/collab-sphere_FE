            ...
            {!token ? (
              ...
              <div className='relative' ref={dropdownRef}>
                <button
                  ...
                  className='flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-blue-50 rounded-lg transition-colors'
                >
                ...
                {dropdownOpen && (
                  <div className='absolute right-0 mt-2 w-44 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden z-50'>
                    ...
                    <button
                      ...
                      className='w-full text-left flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 border-t border-gray-100'
                    >
