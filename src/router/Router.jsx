...
const studentRoutes = [
  ...
  { path: '/student/classes/:classSlug', element: protectRoute(['STUDENT'], <StudentClassPage />) },
  ...
  { path: '/student/project/milestones&checkpoints/:milestoneId', element: protectRoute(['STUDENT', 'LECTURER'], <MilestoneCheckpointPage />) },
  ...
  { path: '/meeting', element: protectRoute(['STUDENT'], <Layout/>) },
  { path: '/join-room', element: protectRoute(['STUDENT', 'LECTURER'], <RoomJoinPage/>)},
  { path: '/room/:roomId', element: protectRoute(['STUDENT', 'LECTURER'], <MeetingRoom/>)},
  { path: '/meeting/history', element: protectRoute(['STUDENT', 'LECTURER'], <MeetingManagement/> )},
  { path: '/meeting/schedule', element: protectRoute(['STUDENT', 'LECTURER'], <MeetingSchedulerFull/> )},
  ...
  { path: '/student/meeting/history', element: protectRoute(['STUDENT'], <StudentMeetingManagement/> )},
];
...
const lecturerRoutes = [
  ...
  { path: '/lecturer/grading/team/:teamId/milestones/evaluate/:milestoneId', element: protectRoute(['LECTURER'], <MilestoneEvaluationPage />) },
  ...
  { path: '/lecturer/grading/class/:classId/team/:teamId/milestones/evaluate/:milestoneId', element: protectRoute(['LECTURER'], <MilestoneEvaluationPage />) },
