            ...
            <aside className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-fuchsia-600 via-purple-600 to-pink-600 px-12 py-12 text-white lg:flex">
              ...
              <div className="relative">
                <div className="inline-flex items-center gap-3 rounded-2xl bg-white/15 px-4 py-2 backdrop-blur-xl">
                  ...
                  <span className="text-sm font-semibold tracking-wide text-pink-50/90 uppercase">Empower learning</span>
                </div>
                <h2 className="mt-8 text-4xl font-semibold leading-tight tracking-tight">Shape collaborative cohorts with confidence.</h2>
                <p className="mt-4 max-w-sm text-base text-pink-100/90">
                  Create lecturer and student accounts, distribute projects, and automate onboarding in minutes.
                </p>
              </div>
              <ul className="relative mt-10 space-y-4">
                {[{
                  ...
                  <li key={title} className="flex gap-4">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-pink-50/95">{title}</p>
              ...
              <div className="px-8 py-10 sm:px-10 lg:px-12 lg:py-12">
                <div className="mb-8 flex items-center justify-center gap-3 lg:justify-start">
                  ...
                  <div className="text-center lg:text-left">
                    <p className="text-xs font-semibold uppercase tracking-[0.35em] text-slate-400">Register</p>
                    <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Create your account</h1>
                    <p className="text-sm text-slate-500">Unlock collaborative tooling for your cohort</p>
                  </div>
                </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p
                          className={`text-xs font-medium ${
                            passwordStrength >= 3 ? 'text-emerald-600' : 'text-slate-500'
                          }`}
                        >
                  ...
                  <div>
                    <label className="flex items-start gap-3 rounded-2xl border border-transparent px-3 py-2.5 transition-all duration-300 hover:border-fuchsia-200/60 hover:bg-white/60">
                      ...
                      <span className="text-sm text-slate-600">
                        I agree to the{' '}
                        <Link to="/terms" className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 via-purple-600 to-pink-600">
                          Terms of Service
                        </Link>
                        {' '}and{' '}
                        <Link to="/privacy" className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 via-purple-600 to-pink-600">
                          Privacy Policy
                        </Link>
                      </span>
                    </label>
                    {errors.agreeToTerms && (
                      <p className="mt-2 text-sm text-rose-500">{errors.agreeToTerms}</p>
                    )}
                  </div>
