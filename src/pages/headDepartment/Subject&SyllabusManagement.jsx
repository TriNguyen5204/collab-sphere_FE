...
export default function ImprovedSubjectManagement() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6'>
                ...
                <div className='bg-white rounded-lg p-5 border border-gray-200 shadow-sm'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-sm bg-green-500 text-white px-4 py-2 rounded-lg font-semibold shadow-sm'>
                      {getSyllabus(selectedSubject.subjectId)?.credits} credits
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className='p-6 space-y-6'>
                ...
                <div>
                  ...
                  <div className='space-y-3'>
                    {getOutcome(selectedSubject.subjectId)?.gradeComponents.map(
                      (g, i) => (
      ...
      >
        <CreateMultipleSubjectForm onClose={() => setIsModalOpen(false)} />
      </ModalWrapper>
    </div>
  );
}
