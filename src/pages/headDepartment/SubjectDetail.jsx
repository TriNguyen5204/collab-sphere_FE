            ...
            <div className="relative z-10 px-6 py-8 lg:px-10">
              ...
              <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                ...
                <button
                  ...
                  className='flex items-center gap-2 bg-orangeFpt-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orangeFpt-600 transition-all shadow-lg shadow-orangeFpt-200 hover:shadow-xl active:scale-[0.98]'
                >
            ...
            <div className='bg-amber-50 border-2 border-amber-200 rounded-2xl p-6'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-600'>
                    This subject does not have a syllabus assigned yet. Click "Edit Subject" to add syllabus information.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='lg:col-span-2 space-y-6'>
                    ...
                    <div className='space-y-3'>
                      {syllabus.subjectOutcomes.map((outcome, index) => (
                        <div
                          ...
                          className='flex gap-4 p-4 bg-slate-50 rounded-xl hover:bg-orangeFpt-50/50 transition-colors border border-transparent hover:border-orangeFpt-100'
                        >
                          <div className='w-8 h-8 bg-orangeFpt-500 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm'>
              ...
              {syllabus?.subjectGradeComponents?.length > 0 && (
                <div className='bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden'>
                  ...
                  <div className='p-6'>
                    <p className='text-slate-500 text-sm mb-5'>
                      Final grade calculation based on the following components:
                    </p>
                      ...
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          ...
                          <p className='font-medium text-slate-900'>
                            {new Date(syllabus.createdDate).toLocaleDateString('en-US', {
                              month: 'long',
                              day: 'numeric',
                              year: 'numeric',
                            })}
