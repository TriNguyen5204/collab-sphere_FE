          ...
          <div className='relative overflow-hidden rounded-3xl border border-orangeFpt-50 bg-gradient-to-tl from-orangeFpt-50 via-white/45 to-white shadow-md shadow-orangeFpt-100/60 backdrop-blur'>
            ...
            <div className='relative z-10 px-6 py-8 lg:px-10'>
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  onClick={() => navigate(-1)}
                  className='flex items-center gap-2 text-slate-600 hover:text-orangeFpt-600 transition-colors font-medium text-sm'
                >
                ...
                <button
                  ...
                  className='flex items-center gap-2 px-4 py-2 bg-white text-orangeFpt-600 rounded-xl font-semibold text-sm shadow-sm border border-orangeFpt-100 hover:bg-orangeFpt-50 transition-all'
                >
              ...
              <div className='flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between'>
                <div className='space-y-4 flex-1'>
                  <div className='flex items-center gap-3 flex-wrap'>
                    ...
                    <span
                      className={`px-3 py-1.5 rounded-lg text-xs font-bold ${subject.isActive
